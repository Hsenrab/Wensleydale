...
class ChangingLightPattern(ColorCycleTemplate):
    ...
    def colour_to_wheel_param(colour):
        if(colour == enums.WColour.Red):
            return 85, 50
        elif(colour == enums.WColour.Blue):
            return 0, 100
        elif(colour == enums.WColour.Green):
            return 170, 100
        elif(colour == enums.WColour.Cyan):
            return 225, 100
        elif(colour == enums.WColour.Yellow):
            return 100, 60
        elif(colour == enums.WColour.Pink):
            return 50, 75
        elif(colour == enums.WColour.Orange):
            return 85, 50
        else: # enums.WColour.White
            return 0, 1
